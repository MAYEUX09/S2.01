...
class RobotDijkstraTest {
    ...
    @Test
    void testDijkstra_SourceEgaleCible() {
    ...
    @Test
    void testDijkstra_CheminLibreVersEst() {
    ...
    // C10=F, C11=V
    @Test
    void testDijkstra_CheminLibreVersOuest() {
    ...
    // C8=V
    @Test
    void testDijkstra_CheminLibreVersNord() {
    ...
    // C8=F, C9=V
    @Test
    void testDijkstra_CheminLibreVersSud() {
    ...
    @Test
    void testDijkstra_ContournementRobot() {
    ...
    @Test
    void testDijkstra_RobotSurCible() {
        Robot autreRobot = new Robot(2, "NI", 7, 3, 5, 6);
        grille[5][6].setRobot(autreRobot);
        String resultat = robot.executerDijkstra(grille, 5, 6);
        assertEquals("est", resultat);
    ...
    @Test
    void testDijkstra_CheminImpossible() {
